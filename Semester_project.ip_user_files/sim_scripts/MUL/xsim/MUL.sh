...
#
# Generated by Vivado on Tue Jan 25 23:47:42 +0500 2022
...
# Script info
echo -e "MUL.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_8 -L xbip_pipe_v3_0_4 -L xbip_bram18k_v3_0_4 -L mult_gen_v12_0_13 -L xil_defaultlib -L secureip -L xpm --snapshot MUL xil_defaultlib.MUL -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/Windows/Vivado/2017.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
